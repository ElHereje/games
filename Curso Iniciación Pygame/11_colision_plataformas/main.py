...
class Game:
	def __init__(self):
		...
		# vamos a crear una lista independiente para las plataformas:
	...
	def instancias(self):
		...
		# Instanciamos las plataformas diseñadas
		for i in range(4):# haremos solo 4 a alturas de 165 * i
			...
			# añadimos tambien las plataformas a la lista recién creada para
			# el tema de las colisiones con plataformas
