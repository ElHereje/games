'''
Generamos la codificación para el fondo y la transparencia.
Se  codifican 2 tipos de fondos, uno con estrellas con scroll
y otro con imagen fija
