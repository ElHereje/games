...
La CPU intenta realizar 4 en raya.'''
...
while not salir:
    ...
    empate = False
    turno = ra1_5.devuelve_numero_random(0, 9)


    jugador = ra1_5.Jugador()
    ...
    while not empate:
        ...
        jugador_cuatro_en_raya = ra1_5.checkear_4enraya(lista_check_horiz, lista_check_vert, lista_cuadricula, 'O')
        cpu_cuatro_en_raya = ra1_5.checkear_4enraya(lista_check_horiz, lista_check_vert, lista_cuadricula, 'X')

        # Comprobamos 4enRaya diagonales
        jugador_cuatro_en_diag = ra1_5.checkear_diagonales(lista_check_diag,lista_cuadricula, 'O')
        cpu_cuatro_en_diag = ra1_5.checkear_diagonales(lista_check_diag,lista_cuadricula, 'X')
        ...
        if turno:
            if columna == -1:
                ...
                if not turno:
                    cpu_col = ra1_5.cpu_intenta_4raya(lista_check_horiz, lista_check_vert,
                    lista_check_diag, lista_cuadricula, lista_x100)
                    if cpu_col == -1:
                        cpu = ra1_5.Cpu(RES, lista_cuadricula, cpu_col)
            ...
            if turno:
                ...
                jugador = ra1_5.Jugador() # nueva ficha
                lista_sprites_adibujar.add(jugador)
