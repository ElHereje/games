...
# Implementamos el intento de la CPU para gacer 4enRaya
...
# 1 - Implementamos la función de defensa de la CPU
# es igual que la anterior, pero comprueba la ficha contraria
