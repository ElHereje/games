...
class Fantasma(pygame.sprite.Sprite):
    def __init__(self, game, centerx, centery, tipoFantasma, direccion):
        ...
        # 2 - creamos el array ptosClave (coord. de ptos clave de la pantalla)
        self.ptosClave = [
            # izq
    ...
    def update(self):
        ...
        # 1 - Averiguamos hacia donde debe ir (donde está pacman)
    ...
    # 3 - xcreamos la funciónpara que nos persigan loos fantasmas
