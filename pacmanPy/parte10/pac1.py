...
class PacMan(pygame.sprite.Sprite):
    ...
    # creamos una función de colisión con los puntitos y otra para los items
    ...
    # 3 - modificamos las colisiones añadiendo un parámetro --> colisión circular
...
# clase PacManDies (lleva una animación)
...
# 9 Creamos la clase para gestionar las vidas
