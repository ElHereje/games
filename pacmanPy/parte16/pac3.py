...
class Items(pygame.sprite.Sprite):
    ...
    # 8 - GESIONAMOS LA APARICIÓN DEL RESTO DE FRUTAS
        # las frutas estaraán relacionadas con el nivel
        fruta = self.game.nivel
        if fruta > 4:
            fruta = 4
        img = pygame.image.load(f'pacGraf/item{fruta}.png').convert()
        ...
        # gestionamos los puntos por fruta
